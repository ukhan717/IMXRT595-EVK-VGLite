...
/* ******************************************************************************
   ...
   **************************************************************************** */
#define EW_PLATFORM_STRING    "IMXRT595-EVK"
...
#define DEMO_PANEL DMB_PANEL // DEMO_PANEL_RM67162 //
  ...
  #elif EW_FRAME_BUFFER_COLOR_FORMAT == EW_FRAME_BUFFER_COLOR_FORMAT_RGBA8888
    #define DEMO_RM67162_USE_RG565    0
    #define DEMO_RM67162_USE_XRGB8888 1
  #else
    #error Selected color format not supported!
  #endif
#else
...
#define EW_USE_DOUBLE_BUFFER            1
  ...
  #define EW_DISPLAY_WIDTH                390
  #define EW_DISPLAY_HEIGHT               390
...
/* ******************************************************************************
   ...
   **************************************************************************** */
#define EW_TOUCH_AREA_MIN_X                    390
#define EW_TOUCH_AREA_MIN_Y                    390
...
#define EW_MEMORY_POOL_SIZE      (3500 * 1024)
...
#define EW_MAX_SURFACE_CACHE_SIZE    0x40000
...
#define EW_DISCARD_BITMAPS_IF_NOT_USED_IN_CURRENT_UPDATE  1
